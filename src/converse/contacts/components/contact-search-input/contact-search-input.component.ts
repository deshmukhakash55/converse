...
} from 'src/converse/nav/store/actions/actions';
import { searchContacts } from 'src/converse/nav/store/selectors/selectors';
...
export class ContactSearchInputComponent implements OnInit, OnDestroy {
